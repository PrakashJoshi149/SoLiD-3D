function [W, coordinates] = GetWeights_2D(x,y,tdata,weight_type)
%  This is the matlab code for the C function GetW in inv_lwm.c
%  Given a location in output space (x,y), find the weights of each 
...
Ri = dist_to_cp ./ tdata.tdata.RadiiOfInfluence;			% This is the 12th closest point by Matlab default
